 ...
 * @author sala308b
 */
@WebServlet(name = "ListaCriancaServlet", urlPatterns = {"/criancas"})
public class ListaCriancaServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(ListaCriancaServlet.class.getName()).log(Level.SEVERE, null, ex);
